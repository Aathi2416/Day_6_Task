...
const movieDetails = new movie("Leo","Zee studios", "PG-14");
...
const movie1 = new movies("Leo","Zee studios");
console.log(movie1);

//
const movie2 = new movies("Leo","Zee studios","PG-14");
console.log(movie2);
...
let moviee2 = new Moviee("ok ok", "Sri ", "V");
let movie3 = new Moviee("Master", "KRG Studios", "PG");
